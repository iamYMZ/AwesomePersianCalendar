...
public class CoreCalendar {
     ...
     */
    public CoreCalendar(int year, int month, int day) {
        set(year, month, day);
    }


    public CoreCalendar(GregorianCalendar gc){
        fromGregorian(gc);
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    public CoreCalendar(LocalDate ld) {
        fromGregorian(GregorianCalendar.from(ld.atStartOfDay(ZoneId.systemDefault())));
    }


    public CoreCalendar(Date date) {
     ...
     */
    public CoreCalendar getYesterday() {
     ...
     */
    public CoreCalendar getTomorrow() {
        return getDateByDiff(1);
    }
     ...
     */
    public CoreCalendar getDateByDiff(int diff) {
        GregorianCalendar gc = toGregorian();
        gc.add(Calendar.DAY_OF_MONTH, diff);
        return new CoreCalendar(gc);
    }
    ...
    public boolean equals(Object o) {
        ...
        CoreCalendar that = (CoreCalendar) o;
    ...
    private void fromJulianDay(int JulianDayNumber) {
        ...
        GregorianCalendar gregorianFirstFarvardin = new CoreCalendar(jalaliYear, 1, 1).getGregorianFirstFarvardin();
